/* ============================================================
   Animación del yeti para la página 404.

   AVISO: este script NO es mio. La animación, los morph de
   la boca y la coreografía vienen del siguiente CodePen:

       Autor original: David Senneff (dsenneff)
       Fuente:         https://codepen.io/dsenneff/pen/mjZgmN

   El código original usaba la API antigua de GSAP 2 (TweenMax /
   TimelineMax) y un CDN de plugins que GreenSock retiró cuando
   GSAP pasó a ser 100% gratis en 2025. Lo único que hemos
   cambiado es traducir las llamadas a la API equivalente de
   GSAP 3 (gsap.timeline, gsap.to, gsap.set, .call) para que
...
yetiTL
	...
	.call(function () { chatterTL.play(); }, null, 9.25)
